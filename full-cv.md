...
**📄** Full CV:
[github.com/bmpvieira/bmpvieira/blob/main/cv.md](https://github.com/bmpvieira/bmpvieira/blob/main/cv.md)
...
-   Integration with GitHub, GitLab, and authentication.
...
Main tech used: TypeScript, React, AWS, K8S, Docker, Podman, Nix,
Microservices, Nginx, MongoDB, Redis, GCP, Azure, Terraform, Packer,
Hadoop, OpenAPI
...
Main tech used: Nix, NodeJS, Python, Dask, PyTorch, Bioinformatics
...
Tech: Nix, Docker, AWS, GCP, Kubernetes, Ember.js
...
Tech: NodeJS Streams, Bioinformatics,
[NCBI](https://www.ncbi.nlm.nih.gov/) API
...
XIV Congress of the European Society for Evolutionary Biology (1500
...
Tech used: NodeJS, Express.js, MongoDB, Coffee Script, Jade, Twitter
Bootstrap, jQuery.
...
Tech: Bioinformatics, Python, R, Arch Linux (btw), AngularJS
...
population size (*N~e~*). I co-authored 3 papers. At some point I had 40
...
I\'ve submitted my thesis but not defended it yet.
