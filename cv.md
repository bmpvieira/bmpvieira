...
I am a PhD student in Bioinformatics and Population Genomics at the Queen Mary University of London ([WurmLab](http://wurmlab.github.io)) and also a Node.js Web Developer.

I founded and lead the open source community project [BioNode](http://bionode.io) (modular and universal bioinformatics) and I am a member of the [Dat](http://dat-data.com) team (git for data).

I am involved in open source and open research and participate/organise workshops and hackathons.
...
* Vos RA, Katayama T, Mishima H, *et al.* (2020)
...
<!-- * **Web languages**: HTML5, CSS3 and Stylus -->

<!-- * **Templating engines**: Jade and Dust.js -->

* **Databases**:
  MongoDB (used in production), SQL (learned during undergrad)  
  <!-- Neo4J (in [testing](http://neo4j-playground.herokuapp.com/)) -->
  <!-- HDF5 (in testing) -->

<!-- * **Integrated Development Environments**:
  Sublime-text 2 (used in production)
  Vim (in production)
  Cloud9 (in testing)
  Eclipse (in college) -->
...
* 2010 - Logo for the [**Computational Biology & Population Genomics Group (CoBiG²)**](http://cobig2.fc.ul.pt) made with [Blender](http://blender.org) and [Gimp](http://gimp.org).
